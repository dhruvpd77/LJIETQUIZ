...
urlpatterns = [
    ...
    path('subject/<int:subject_id>/unit/<int:unit>/tutorials/', views.unit_tutorials, name='unit_tutorials'),
    path('generate-topic-tutorial/', views.generate_topic_tutorial, name='generate_topic_tutorial'),
